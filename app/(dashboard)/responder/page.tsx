...
export default function ResponderPage() {
    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] bg-slate-50 flex flex-col font-sans">
            ...
            <header className="bg-white border-b border-slate-200 p-4 shadow-sm z-30 sticky top-16">
                <div className="container max-w-md md:max-w-6xl mx-auto flex items-center justify-between">
                    <div className={`p-4 rounded-xl border-2 transition-all flex items-center justify-between flex-1 md:flex-none md:w-96 ${status === 'available' ? 'bg-green-50 border-green-200' :
            ...
            <main className="flex-1 container max-w-md md:max-w-6xl mx-auto p-4 flex flex-col relative">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-lg font-medium text-slate-700">{request.userName}</p>
                ...
                {activeCase && !showResolution && (
                    <div className="space-y-4 flex-1 flex flex-col md:grid md:grid-cols-2 md:gap-8 md:space-y-0 h-full">
                        {/* Map Panel */}
                        <div className="h-64 md:h-[600px] bg-slate-200 rounded-2xl overflow-hidden border border-slate-300 relative shadow-inner md:col-span-1">
                        ...
                        <div className="flex flex-col gap-4 md:col-span-1 h-full">
                            <Card className="border-l-4 border-l-blue-500 shadow-sm flex-1">
                ...
                {showResolution && (
                    ...
                    >
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle className="text-base">1. Incident Outcome</CardTitle>
                            </CardHeader>
                            <CardContent className="grid gap-3">
                                <Button
                                    variant={selectedOutcome === "Resolved On-Site" ? "default" : "outline"}
                                    className={`justify-start h-12 ${selectedOutcome === "Resolved On-Site" ? "bg-slate-900 text-white" : ""}`}
                                ...
                                <Button
                                    ...
                                    className={`justify-start h-12 ${selectedOutcome === "Handed over to Ambulance" ? "bg-slate-900 text-white" : ""}`}
                                ...
                                <Button
                                    ...
                                    className={`justify-start h-12 ${selectedOutcome === "User Unavailable / False Alarm" ? "bg-slate-900 text-white" : ""}`}
                        ...
                        {selectedOutcome && (
                            ...
                            >
                                <p className="text-blue-800 font-bold mb-1">2. Emotional Check-in</p>
                                ...
                                <div className="flex gap-3 justify-center">
                                    ...
                                    <Button onClick={() => finalizeResolution("Offline")} size="sm" variant="outline" className="border-blue-200 text-blue-700 bg-white">Go Offline</Button>
                                </div>
                            </motion.div>
                        )}
                    </motion.div>
